...
public class TspTestContainer extends TestContainer {

    public TspTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/tsp/app.properties",
    ...
    public static class Common extends TspTestContainer {

        public static final TspTestContainer.Common INSTANCE = new TspTestContainer.Common();
